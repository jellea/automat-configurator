...
document.addEventListener('DOMContentLoaded', function(){
           ...
           for (var i = 1; i <= 12; ++i) {
                  ...
                  list3.options[0] = new Option('A0', '21');
                  list3.options[1] = new Option('A#0', '22');
                  list3.options[2] = new Option('B0', '23');
                  list3.options[3] = new Option('C1', '24');
                  list3.options[4] = new Option('C#1', '25');
                  list3.options[5] = new Option('D1', '26');
                  list3.options[6] = new Option('D#1', '27');
                  list3.options[7] = new Option('E1', '28');
                  list3.options[8] = new Option('F1', '29');
                  list3.options[9] = new Option('F#1', '30');
                  list3.options[10] = new Option('G1', '31');
                  list3.options[11] = new Option('G#1', '32');
                  list3.options[12] = new Option('A1', '33');
                  list3.options[13] = new Option('A#1', '34');
                  list3.options[14] = new Option('B1', '35');
                  list3.options[15] = new Option('C2', '36');
                  list3.options[16] = new Option('C#2', '37');
                  list3.options[17] = new Option('D2', '38');
                  list3.options[18] = new Option('D#2', '39');
                  list3.options[19] = new Option('E2', '40');
                  list3.options[20] = new Option('F2', '41');
                  list3.options[21] = new Option('F#2', '42');
                  list3.options[22] = new Option('G2', '43');
                  list3.options[23] = new Option('G#2', '44');
                  list3.options[24] = new Option('A2', '45');
                  list3.options[25] = new Option('A#2', '46');
                  list3.options[26] = new Option('B2', '47');
                  list3.options[27] = new Option('C3', '48');
                  list3.options[28] = new Option('C#3', '49');
                  list3.options[29] = new Option('D3', '50');
                  list3.options[30] = new Option('D#3', '51');
                  list3.options[31] = new Option('E3', '52');
                  list3.options[32] = new Option('F3', '53');
                  list3.options[33] = new Option('F#3', '54');
                  list3.options[34] = new Option('G3', '55');
                  list3.options[35] = new Option('G#3', '56');
                  list3.options[36] = new Option('A3', '57');
                  list3.options[37] = new Option('A#3', '58');
                  list3.options[38] = new Option('B3', '59');
                  list3.options[39] = new Option('C4', '60');
                  list3.options[40] = new Option('C#4', '61');
                  list3.options[41] = new Option('D4', '62');
                  list3.options[42] = new Option('D#4', '63');
                  list3.options[43] = new Option('E4', '64');
                  list3.options[44] = new Option('F4', '65');
                  list3.options[45] = new Option('F#4', '66');
                  list3.options[46] = new Option('G4', '67');
                  list3.options[47] = new Option('G#4', '68');
                  list3.options[48] = new Option('A4',  '69');
                  list3.options[49] = new Option('A#4', '70');
                  list3.options[50] = new Option('B4',  '71');
                  list3.options[51] = new Option('C5',  '72');
                  list3.options[52] = new Option('C#5', '73');
                  list3.options[53] = new Option('D5',  '74');
                  list3.options[54] = new Option('D#5', '75');
                  list3.options[55] = new Option('E5',  '76');
                  list3.options[56] = new Option('F5',  '77');
                  list3.options[57] = new Option('F#5', '78');
                  list3.options[58] = new Option('G5',  '79');
                  list3.options[59] = new Option('G#5', '80');
                  list3.options[60] = new Option('A5',  '81');
                  list3.options[61] = new Option('A#5', '82');
                  list3.options[62] = new Option('B5',  '83');
                  list3.options[63] = new Option('C6',  '84');
                  list3.options[64] = new Option('C#6', '85');
                  list3.options[65] = new Option('D6',  '86');
                  list3.options[66] = new Option('D#6', '87');
                  list3.options[67] = new Option('E6',  '88');
                  list3.options[68] = new Option('F6',  '89');
                  list3.options[69] = new Option('F#6', '90');
                  list3.options[70] = new Option('G6',  '91');
                  list3.options[71] = new Option('G#6', '92');
                  list3.options[72] = new Option('A6',  '93');
                  list3.options[73] = new Option('A#6', '94');
                  list3.options[74] = new Option('B6',  '95');
                  list3.options[75] = new Option('C7',  '96');
                  list3.options[76] = new Option('C#7', '97');
                  list3.options[77] = new Option('D7',  '98');
                  list3.options[78] = new Option('D#7', '99');
                  list3.options[79] = new Option('E7',  '100');
                  list3.options[80] = new Option('F7',  '101');
                  list3.options[81] = new Option('F#7', '102');
                  list3.options[82] = new Option('G7',  '103');
                  list3.options[83] = new Option('G#7', '104');
                  list3.options[84] = new Option('A7',  '105');
                  list3.options[85] = new Option('A#7', '106');
                  list3.options[86] = new Option('B7',  '107');
                  list3.options[87] = new Option('C8',  '108');
            }
                          });
